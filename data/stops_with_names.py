...
# Load the JSON files
with open("public_transport_routes.json", "r", encoding="utf-8") as f:
    routes_data = json.load(f)

with open("public_transport_stops.json", "r", encoding="utf-8") as f:
    stops_data = json.load(f)

# Create a mapping of nr_zespolu to nazwa_zespolu
zespol_to_nazwa = {}
...
# Extract stops and map to stop names
stops_with_names = {}
...
print("Extraction complete! The output is saved in stops_with_names.json")
